  ...
  return _regenerator["default"].async(function lessVarsLoader$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _ref = (_getOptions = (0, _loaderUtils.getOptions)(this)) !== null && _getOptions !== void 0 ? _getOptions : function (_ref2) {
            var _ref3 = (0, _slicedToArray2["default"])(_ref2, 2),
                key = _ref3[0],
                value = _ref3[1];

            return [(0, _camelCase["default"])(key), /^\d+px$/.test(value) ? (0, _parseInt2["default"])(value, 10) : value];
